...
namespace UOWRepositoryUsingEFinMVC.GenericRepository
{
    public class GenericRepository<T> : IGenericRepository<T>, IDisposable where T : class
    {
        ...
        public GenericRepository(IUnitOfWork<EmployeeDBModel> unitOfWork)
        ...
        public EmployeeDBModel Context { get; set; }
