...
using UOWRepositoryUsingEFinMVC.EmployeeRepository;
using UOWRepositoryUsingEFinMVC.GenericRepository;
using UOWRepositoryUsingEFinMVC.UnitOfWork;

namespace UOWRepositoryUsingEFinMVC.Controllers
{
    public class EmployeeController : Controller
    {
        private UnitOfWork<EmployeeDBModel> unitOfWork = new UnitOfWork<EmployeeDBModel>();
        ...
        public EmployeeController()
        {
            ...
            employeeRepository = new EmployeeRepository.EmployeeRepository(unitOfWork);
        }
